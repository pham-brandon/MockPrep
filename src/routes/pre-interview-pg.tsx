...
import { Lightbulb, Sparkles, Webcam as WebcamIcon, Loader2, Mic, MicOff, Volume2, Pencil, Save, Trash2 } from 'lucide-react';
                  ...
                  <div className="flex flex-col items-center justify-center p-6 text-center space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {navigator.mediaDevices ? 
                        "Optional: Camera access is not required but recommended to mimic a real interview setting" : 
                        "Unable to access camera. This is optional but recommended for a realistic interview experience."}
                    </p>
                  </div>
                )}
              </div>
              <p className="mt-4 text-sm text-muted-foreground">
                Your video is never recorded. This is just to help you practice in a setting similar to a real interview.
              </p>
            </Card>
                ...
                {isMicEnabled ? (
                  ...
                  <div className="flex flex-col items-center p-4 text-center">
                    ...
                    <p className="text-sm text-muted-foreground px-2">
                      {navigator.mediaDevices ? 
                        "Optional: Microphone access is not required, typing option is available" : 
                        "Unable to access microphone. This is optional but recommended for a realistic interview experience."}
                    </p>
                  </div>
                )}
              </div>
              <p className="mt-4 text-sm text-muted-foreground">
                Your voice is never recorded. This is just to help you practice in a setting similar to a real interview.
              </p>
            </Card>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete the interview and all its data.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
